public class AccountTest {
    public static void main(String[] args) {
        ...
        Account account2 = new Account("abcdef", -2000.0);
        Account account3 = new Account();
//        System.out.println("帳戶號碼: " + account1.getAccountNumber());
//        System.out.println("初始餘額: " + account1.getBalance());

        System.out.printf("帳戶號碼: %s%n初始餘額: %s%n", account1.getAccountNumber(), account1.getBalance());
        System.out.printf("帳戶號碼: %s%n初始餘額: %s%n", account2.getAccountNumber(), account2.getBalance());
        System.out.printf("帳戶號碼: %s%n初始餘額: %s%n", account3.getAccountNumber(), account3.getBalance());
...
//        }
        ...
        try{
            ...
            System.out.printf("提款: %s%n目前餘額: %.2f%n", account2.getAccountNumber(), account2.getBalance());
        }catch (IllegalArgumentException e){
            System.out.println("提款錯誤" + e.getMessage());
        }
    }
